...
**POL.PPR.015**: You **should** read and follow the [secure waste disposal](/guidance/security/report-a-security-incident/secure-waste-disposal/) guidance on the MoJ Intranet before disposing of any document or files.
...
**POL.PPR.017**: If you suspect that the security of the information you work with has been compromised in any way, you **shall** [report it immediately](https://security-guidance.service.justice.gov.uk/reporting-an-incident/).
