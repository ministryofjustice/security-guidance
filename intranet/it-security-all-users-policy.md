...
This policy provides more information on the actions expected of all Ministry of Justice (MoJ) users when using MoJ equipment and infrastructure. It is a sub-page to the [IT Security Policy Overview](https://security-guidance.service.justice.gov.uk/it-security-policy-overview/).
...
* Classified correctly as detailed in the [Information Classification, Handling and Security Guide](https://security-guidance.service.justice.gov.uk/information-classification-handling-and-security-guide/)
...
The MoJ [Email guidance](https://security-guidance.service.justice.gov.uk/email/) tells you about safe and secure use of email within the MoJ.

##Remote working and portable devices

The MoJ has in place [Remote Working](https://security-guidance.service.justice.gov.uk/remote-working/) guidance that sets out the requirements for safely accessing and using the MoJ's systems and applications when working remotely, for example from home, another government office, or while travelling.

Mobile computing is the use of portable equipment such as mobile phone, laptop or tablet, and which supports remote working. Mobile computing equipment provided by the MoJ must be used in line with the [Acceptable Use Policy](https://security-guidance.service.justice.gov.uk/acceptable-use-policy/).

Any request to take MoJ IT equipment overseas must follow the guidance provided in the [Acceptable Use Policy](https://security-guidance.service.justice.gov.uk/acceptable-use-policy/) and the [Accessing MoJ IT Systems From Overseas](https://security-guidance.service.justice.gov.uk/accessing-moj-it-systems-from-overseas/) information.
