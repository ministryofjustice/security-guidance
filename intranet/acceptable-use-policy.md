...
`POL.ITAUP.005`: All Users **SHALL** be made aware that non-conformance to the system SyOPs constitutes a breach of the MoJ [IT Security Policy](https://security-guidance.service.justice.gov.uk/it-security-policy-overview/), and **MIGHT** result in disciplinary action.
...
`POL.ITAUP.016`: MoJ systems **SHALL NOT** be used for any activity that causes offence to MoJ employees, customers, suppliers, partners, or visitors, or used in a way that violates the [MoJ Code of Conduct](/guidance/hr/conduct-behaviour/).
...
Email is a major source of malware, and a route into the MoJ for criminal organisations. It **MIGHT** be used to defraud staff, or to exfiltrate information. All Users **SHALL** exercise care when handling emails, and [report any suspicious activity as an IT security incident](https://security-guidance.service.justice.gov.uk/reporting-an-incident/).
...
`POL.ITAUP.024`: Where a User suspects that an email received is from an untrusted, unknown, or unsolicited source, they **SHALL** [report it as an IT security incident](https://security-guidance.service.justice.gov.uk/reporting-an-incident/).
...
MoJ security maintains a [list of countries](https://security-guidance.service.justice.gov.uk/accessing-moj-it-systems-from-overseas/) where carriage and use of remote access devices is permitted.

Further details can be found in the [Remote Working](https://security-guidance.service.justice.gov.uk/remote-working/) guidance.

`POL.ITAUP.025`: All Users **SHALL** be aware of the [Remote Working](https://security-guidance.service.justice.gov.uk/remote-working/) guidance, and **SHALL** confirm that they have read and understood it before being provided with any remote access devices or equipment, such as an encryption or access control token.

`POL.ITAUP.026`: Any User wishing to take a remote access device out of the UK **SHALL** consult the [Remote Working](https://security-guidance.service.justice.gov.uk/remote-working/) guidance before doing so, and the applicable device IT Security Operating Procedures document.
...
* [Acceptable Use Protocol Commercial and Contract Management](/documents/2020/12/acceptable-use-protocol-commercial-and-contract-management.pdf)
* [Acceptable Use Protocol Subject Access Requests](/documents/2020/12/acceptable-use-protocol-subject-access-requests.pdf)
* [Acceptable Use Protocol Storage of Personal Data](/documents/2021/02/acceptable-use-protocol-storage-of-personal-data.pdf)
* [Acceptable Use Protocol Data Subjects' Rights](/documents/2021/04/acceptable-use-protocol-data-subjects-rights.pdf)
* [Acceptable Use Protocol Processing of People Data](/documents/2021/04/acceptable-use-protocol-processing-of-people-data.pdf)
* [Acceptable Use Protocol Analytical Platform](/documents/2021/04/acceptable-use-protocol-analytical-platform.pdf)
* [Acceptable Use Protocol Recording](/documents/2021/04/acceptable-use-protocol-recording.pdf)

There are also a number of Standard Operating Procedures (SOP)s, including:

* [Personal Data Risk Management](/documents/2021/03/standard-operation-procedure-personal-data-risk-management.pdf)
