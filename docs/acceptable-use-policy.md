...
This document is the Ministry of Justice \(MoJ\) Acceptable Use Policy. It provides the core set of security principles and expectations on the acceptable use of MoJ systems.

## Introduction

MoJ systems and services are first and foremost provided to support the delivery of the MoJ's business services. To achieve this, most MoJ users are provided with:

-   An appropriate general purpose computer environment, such as a laptop.
-   Access to services and communication tools such as e-mail and the Internet.

This policy describes:

-   The acceptable use of MoJ systems and services.
-   Expectations the MoJ has on its staff in this area.

## Scope

This policy covers all Users \(including contractors and agency staff\) who use MoJ systems or services.

It applies to MoJ HQ. It also applies to Executive Agencies and Arms Length Bodies, although local changes might apply. Where there is any ambiguity or omission when comparing this \(HQ\) policy and local changes, this \(HQ\) policy takes precedence.

Failure to adhere to this policy could result in:

-   Suspension of access to MoJ systems and services.
-   For MoJ employees, disciplinary proceedings up to and including dismissal.
-   For others with access to MoJ systems and services, \(specifically contractors and agency staff\) termination of contract.
...
Some SyOPS are generic, and apply to all MoJ systems. They are described within this document.

It is important that all Users of an MoJ system \(include support and system administrative Users\) are familiar with the SyOPs in this policy, and any other SyOPS specific to the MoJ system, and are provided with the appropriate training.
...
The policy refers to a key set of policies and guidance, as follows:

-   [System Administrators Policy](system-administrators-policy.md).
