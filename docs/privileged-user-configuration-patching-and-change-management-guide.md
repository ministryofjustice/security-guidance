...
-   Ensure that operating systems are fully supported by the relevant platform vendor or an service team. If the system is not supported, consult with the system owner and the [Cyber Assistance Team](#incidents-and-contact-details) for advice. A lack of ongoing support might create security risks within the system and the wider networks.
