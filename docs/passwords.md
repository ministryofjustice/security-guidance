...
Ensure the password storage security matches the [classification](official-official-sensitive.md) of the system or data. For help with the appropriate strength of hashing, contact the [information assurance](https://intranet.justice.gov.uk/guidance/knowledge-information/protecting-information/information-assurance-roles/) team, or the security team: [security@digital.justice.gov.uk](mailto:security@digital.justice.gov.uk)
