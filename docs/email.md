...
-   Don't forward email [chain letters](#chain-letters) to your contacts. Instead, report them to .
...
-   Check if the call is genuine with your . [Report the call](reporting-an-incident.md) as a security incident if it is not. Use a different phone from that used to take the original call.
...
1.  Make provision for someone to have access to your work email account during your absence. If you don't know how to do this, [contact your](#general-enquiries-including-theft-and-loss).
