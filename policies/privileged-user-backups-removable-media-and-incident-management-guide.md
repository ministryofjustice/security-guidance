...
Privileged users need to ensure that there are frequent backups of system data in order to minimise the impact of incidents such as malware infection or data loss. Privileged users must: 
 ...
 - assign all backup media a Protective Marking and provide appropriate protection based on that markin. Backup material must only be accessible to those who have a ‘need-to-know’, defined by the System Owner.
