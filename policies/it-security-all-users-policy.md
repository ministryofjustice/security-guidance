...
This policy provides more information on the actions expected of all MoJ users when using MoJ equipment and infrastructure. It is a sub-page to the [IT Security Policy](https://github.com/ministryofjustice/security-guidance/blob/Local/policies/it-security-policy-overview.md).
